...
<?php
echo '<h2>'.$film['titel'].'</h1><img src="'.$film['bild'].'"><h3>Rating: '.$film['rating'].'</h3><br>'.$film['beskrivning'].'<br><a href="http://xn--mlnet-mra.se/video/player.php?url='.$film['url'].'"><b>Play!</b></a>';
