...
{
var f = document.getElementById('file2add');
f.value = k;
...
if(isset($_POST['addmovie']))
{
	$title='"'.$_POST['title'].'"';
	$path='"'.$_POST['file2add'].'"';
	shell_exec("./movieinfo.py $title $path");
...
<h3>Add movie to library</h3><br>
<form id="convertform" name="convertform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
<input type="hidden" id="file2add" name="file2add" value="">
<input type="text" value="" name="movie" id="movie"><br>
Enter title: <input type="text" value="" id="title" name="title"><br>
